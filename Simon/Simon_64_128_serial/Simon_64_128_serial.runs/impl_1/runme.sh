...
HD_PWD='F:/Documenti 2/University/Magistrale/Progettazione di Sistemi Integrati/VHDL projects/Xilinx_contest/Simon/Simon_64_128_serial/Simon_64_128_serial.runs/impl_1'
cd "$HD_PWD"
