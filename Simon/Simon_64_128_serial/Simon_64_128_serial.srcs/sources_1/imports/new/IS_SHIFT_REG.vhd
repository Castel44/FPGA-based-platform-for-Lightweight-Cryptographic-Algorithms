...
IS_2n1_out <= temp_reg(63 downto 63);

IS_2n2_out <= temp_reg(62 downto 62);

IS_2n8_out <= temp_reg(56 downto 56);

IS_n1_out <= temp_reg(31 downto 31);

IS_n2_out <= temp_reg(30 downto 30);

IS_n8_out <= temp_reg(24 downto 24);
