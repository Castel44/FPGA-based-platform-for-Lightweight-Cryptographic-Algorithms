...
HD_PWD='F:/Documenti 2/University/Magistrale/Progettazione di Sistemi Integrati/VHDL projects/Xilinx_contest/Simon/Simon_64_128_parallel/Simon_64_128_parallel.runs/synth_1'
cd "$HD_PWD"
