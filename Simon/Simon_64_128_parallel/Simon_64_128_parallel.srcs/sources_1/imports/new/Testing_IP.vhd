...
ARCHITECTURE Behavioral OF Testing_IP IS
	...
	-- DUT: Simon with Block size = 64 bit; Key size = 128 bit
	-- Datapath = 32 bit
	COMPONENT Simon_64_128_parallel IS
		PORT (
...
-- Component Instantiation
	...
	-- Cipher under Test
	Simon_DUT : Simon_64_128_parallel
	PORT MAP(
		clk => clk,
	...
	BEGIN
		CASE current_state IS
			...
			WHEN waiting =>
				...
				-- transition  
                -- Since datapath is 24 bit, it takes 4 clk clycle to correct load new key and plaintext
