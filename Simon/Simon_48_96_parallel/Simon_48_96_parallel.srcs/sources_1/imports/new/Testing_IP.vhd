...
component Simon_48_96_parallel is
 Port ( 
...
signal plaintext_tst: std_logic_vector(Datapath*4 - 1 downto 0) := (X"000000000000" & X"72696320646e" );
...
Simon_DUT: Simon_48_96_parallel 
    port map ( 
      clk => clk,
