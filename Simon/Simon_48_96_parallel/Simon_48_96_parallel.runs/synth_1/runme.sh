...
HD_PWD='F:/Documenti 2/University/Magistrale/Progettazione di Sistemi Integrati/VHDL projects/Xilinx_contest/Simon/Simon_48_96_parallel/Simon_48_96_parallel.runs/synth_1'
cd "$HD_PWD"
