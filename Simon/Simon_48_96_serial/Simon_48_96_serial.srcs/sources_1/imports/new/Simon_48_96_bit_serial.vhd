...
entity Simon_48_96_bit_serial is
...
end Simon_48_96_bit_serial;

architecture Behavioral of Simon_48_96_bit_serial is
...
signal MUX8_l_in: std_logic_vector(datapath-1 downto 0); 
signal MUX8_r_in: std_logic_vector(datapath-1 downto 0); 
signal MUX8_out: std_logic_vector(datapath-1 downto 0);

signal MUX2_sel:std_logic; 

signal MUX2_l_in: std_logic_vector(datapath-1 downto 0); 
signal MUX2_r_in: std_logic_vector(datapath-1 downto 0); 
...
generic map (  width => datapath, length => 96)
                                                            ...
                                                            CASE current_state IS
                                                                ...
                                                                WHEN processing => 
                                                                    ...
                                                                    IF serial_cnt_out < b"10111" THEN 
                                                                       ...
                                                                       IF serial_cnt_out < b"10101" THEN --21
                                                                                                  KEYMUX3_sel <= '0';
                                                                                                           ELSE
                                                                                                      KEYMUX3_sel <= '1';
                                                                                                        END IF;            
                                                                                                        
                                                                          IF serial_cnt_out < b"10100" THEN
                                                                                         KEYMUX4_sel <= '0';
                                                                                                       ELSE
                                                                                                    KEYMUX4_sel <= '1';
                                                                                                            END IF;                                    
                                                                    ...
                                                                    IF lfsr_parallel_out = b"11010" THEN 
