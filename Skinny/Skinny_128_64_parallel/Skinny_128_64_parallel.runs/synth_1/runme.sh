...
HD_PWD='F:/Documenti 2/University/Magistrale/Progettazione di Sistemi Integrati/VHDL projects/Xilinx_contest/Skinny/Skinny_128_64_parallel/Skinny_128_64_parallel.runs/synth_1'
cd "$HD_PWD"
