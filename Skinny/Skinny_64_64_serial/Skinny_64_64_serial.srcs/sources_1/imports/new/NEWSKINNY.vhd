...
SIGNAL TW_permutation_out_buf : std_logic_vector(63 DOWNTO 0);
--SUBCELLS SIGNALS
...
BEGIN
    ...
    WHEN loading =>     
        ...
        -- State transition
        IF (cnt_out_buf = b"01111") THEN --count up tp 16 b"1111       
            nx_state <= idle;        
        ELSE        
            nx_state <= loading;        
        END IF;        
    ...
    WHEN processing => 
    -- perform SubCells, AddRoundTweakey and AddConstants      
        -- outputs      
        CIPHERTEXT_OUT <= (OTHERS => '0');
        BUSY <= '1';
