...
HD_PWD='F:/Documenti 2/University/Magistrale/Progettazione di Sistemi Integrati/VHDL projects/Xilinx_contest/Simeck/Simeck_48_96_parallel/Simeck_48_96_parallel.runs/impl_1'
cd "$HD_PWD"
