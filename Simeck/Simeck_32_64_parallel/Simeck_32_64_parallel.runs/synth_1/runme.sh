...
HD_PWD='F:/Documenti 2/University/Magistrale/Progettazione di Sistemi Integrati/VHDL projects/Xilinx_contest/Simeck/Simeck_32_64_parallel/Simeck_32_64_parallel.runs/synth_1'
cd "$HD_PWD"
