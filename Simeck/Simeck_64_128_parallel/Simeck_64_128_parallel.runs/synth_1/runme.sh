...
HD_PWD='F:/Documenti 2/University/Magistrale/Progettazione di Sistemi Integrati/VHDL projects/Xilinx_contest/Simeck/Simeck_64_128_parallel/Simeck_64_128_parallel.runs/synth_1'
cd "$HD_PWD"
