...
-- Subcomponents delcaraton:
	...
	-- Datapath = 32 bit
	COMPONENT Simeck_64_128_parallel IS
		PORT (
...
-- Component Instantiation
	...
	-- Cipher under Test
	Simeck_DUT : Simeck_64_128_parallel
	PORT MAP(
		clk => clk,
	...
	BEGIN
		CASE current_state IS
			...
			WHEN waiting =>
				...
				-- State transition   
				-- Since datapath is 64 bit, it takes 4 clk clycle to correct load new key and plaintext 
