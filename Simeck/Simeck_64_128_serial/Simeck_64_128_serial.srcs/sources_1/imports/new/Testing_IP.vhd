...
------------------------------------------------------------------------------------------------------------
	...
	-- DUT: Simeck with Block size = 64 bit; Key size = 128 bit
	-- Datapath = 1 bit
	COMPONENT Simeck_64_128_bit_serial IS
		PORT (
...
------------------------------------------------------------------------------------------------------------
	...
	SIGNAL plaintext_tst : std_logic_vector(Datapath * 4 - 1 DOWNTO 0) := (X"0000000000000000" & X"656b696c20646e75");	-- plaintext with some zeros concatenate on top of it, makes easier the correct loading into Internal state register
	SIGNAL correct_ciphertext : std_logic_vector(Datapath * 2 - 1 DOWNTO 0) := X"45ce69025f7ab7ed";
...
-- Component Instantiation
	...
	-- Cipher under Test
	Simeck_DUT : Simeck_64_128_bit_serial
	PORT MAP(
		clk => clk,
	...
	BEGIN
		CASE current_state IS
			...
			WHEN waiting =>
				...
				-- State transition   
				-- Since datapath is 1 bit, it takes 128 clk clycle to correct load new key and plaintext
